    ...
    <div className="max-w-2xl mx-auto space-y-5 pb-10">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Stay connected with your clients and workers.
        </p>
      </div>
          ...
          {conversations.map((conversation) => {
            ...
            return (
              <Link
                ...
                className={`card p-4 flex items-center gap-3 transition hover:-translate-y-0.5 hover:shadow-md ${
                  unreadCount ? 'border-brand-blue/30 bg-blue-50/40' : ''
                }`}
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {unreadCount > 0 && (
                      <span
                        className="w-2.5 h-2.5 rounded-full bg-brand-blue shrink-0"
